...
const TransitStopListItem: React.FC<Props> = ({ stop, onCloseButtonClick }) => {
  ...
  return (
    <Container>
      ...
      <ActionBar>
        <ToggleButton onClick={ToggleMap} enabled={isMapOpen}>
          <img src="/map.svg" alt="open map button"></img>
        </ToggleButton>
        <ToggleButton onClick={ToggleFavourite} enabled={isFavourite}>
          <img src="/heart.svg" alt="favourite button" />
        </ToggleButton>
      </ActionBar>
    </Container>
  );
